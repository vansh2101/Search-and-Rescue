...
#? Defining the variables for storing the results
number_of_houses = []
priority_of_houses = []
ratio_of_priority = []
...
for image in images:
    ...
    number_of_houses.append(n_houses)
    priority_of_houses.append(priority_houses)
    ratio_of_priority.append(priority_ratio)
